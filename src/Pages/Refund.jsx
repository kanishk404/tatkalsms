  ...
  return (
    <Wrapper>
      <Main>
        ...
        <p>Thank you for shopping at Tatkal SMS.</p>
        <p>
        ...
        <ul>
          <li>
            <p>
              ...
              in this Agreement) refers to Tatkal SMS.
            </p>
          </li>
          <li>
            <p>
          ...
          <li>
            <p>
              <strong>Website</strong> refers to Tatkal SMS, accessible from{" "}
              <a
                href="https://tatkalsms.me"
        ...
        <ul>
          <li>
            ...
            <a
              href="https://tatkalsms.me/#/contact-us"
              rel="external nofollow noopener"
              target="_blank"
            >
              https://tatkalsms.me/#/contact-us
            </a>
          </li>
        </ul>
        <p>
