      ...
      <Main>
        ...
        <List>
          ...
          <li>
            ...
            "Us" or "Our" in this Agreement) refers to Tatkal SMS.
          </li>
          <li>
          ...
          <li>
            <Bold>Country</Bold> refers to Uttar Pradesh, India.
          </li>
          <li>
          ...
          <li>
            <Bold>Website</Bold> refers to Tatkal SMS, accessible from
            https://tatkalsms.me.
          </li>
          <li>
        ...
        <ul>
          {" "}
          <li>Type: Session Cookies</li> <li>Administered by: Us</li>{" "}
          <li>
        ...
        <ul>
          {" "}
          <li>Type: Persistent Cookies</li> <li>Administered by: Us</li>{" "}
          <li>
        ...
        <p>
          ...
          regarding cookies, please visit our <a>Cookies Policy</a> or the{" "}
          <a>Cookies section of our Privacy Policy</a>.
        </p>
        ...
        <p>
          ...
          <a href="https://tatkalsms.me/contact-us">
